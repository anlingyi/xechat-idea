...
public class BaiDuFyUtil {
     ...
     * 排除双字节中文正则
     */
    private Pattern EXCLUDE_DOUBLE_BYTE_CHINESE_REGEX = Pattern.compile("^[\\x00-\\xff]+$");
    ...
    public String translate(String query) {
        ...
        // 不符合要求，返回
        final boolean isIncludeChinese = !ReUtil.isMatch(EXCLUDE_DOUBLE_BYTE_CHINESE_REGEX, query);
