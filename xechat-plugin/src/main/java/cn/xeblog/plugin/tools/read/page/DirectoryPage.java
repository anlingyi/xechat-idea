...
public class DirectoryPage implements IPage {
    ...
    public void show() {
        ...
        refreshChapterData();
        cn.xeblog.plugin.tools.read.page.UIManager.showPage(directoryPanel, 320, 300);
    }
    ...
    public void initUI() {
        ...
        backButton.addActionListener(e -> cn.xeblog.plugin.tools.read.page.UIManager.readPage.show());
        ...
        chapterList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent mouseEvent) {
                ...
                if (mouseEvent.getClickCount() == 2) {
                    ...
                    if (index >= 0) {
                        cn.xeblog.plugin.tools.read.page.UIManager.readPage.updateProgress(index, 2);
