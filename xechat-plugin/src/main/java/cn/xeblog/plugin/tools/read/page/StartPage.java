...
import cn.xeblog.plugin.tools.read.ui.ReadmeDialog;
...
public class StartPage implements IPage {
    ...
    public void show() {
        ...
        cn.xeblog.plugin.tools.read.page.UIManager.showPage(startPanel, 200, 200);
    }
    ...
    private JButton getStartButton() {
        ...
        button.addActionListener(e -> cn.xeblog.plugin.tools.read.page.UIManager.bookshelfPage.show());
        return button;
    }
